...
export default function DismissibleAlert({ heading, text, show, setShow, variant = `danger` }) {//show, setShow,
    const border = 'border border-5 p-0 m-2 rounded bgAlert bsAlert'; //border and margin style is separate from alert because to fix error of it not appearing in sign up form
    return (<>
