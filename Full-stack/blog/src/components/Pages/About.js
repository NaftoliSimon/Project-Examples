            ...
            <div className='d-block'>
                ...
                <Card className={card}><Card.Body>
                    <ul className='d-block pt-3 pb-0 list-group list-group-flush'>
                        ...
                        <li className={li}><h6 className={h6}>Fetch and display limited amount of data at one time</h6> - when loading the blogs list from the database, instead of loading all of them, instead fetch and show only x amount at a time</li>
