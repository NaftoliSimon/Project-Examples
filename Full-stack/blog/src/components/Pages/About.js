                ...
                <Card className={card}><Card.Body>
                    ...
                    <span>This website contains many features, including:
                        ...
                        <Alert variant='info' className='mt-2 ms-0'>
                            ...
                            If you are not connected to the server the website will work with limited functions.
...
/*
button-outline-primary css, welcome cards, clean up/remove old unnecessary code (especially css/bootstrap), update blog & get rid of blog2
...
Make edited comment immediately reload/change to new edited comment after submitting the edit  
 ...
 Front-end nicer display improvements:  
                    Add a additional @copyright year footer below other footer.
