        ...
        <>
            ...
            <div className={`${center} flex-column ${gap}`}>
                <div className={`${center} ${gap} `}>
                    <Card header={'Read A Blog'} text={readText} buttonText={'Find A Blog'} width={width} cardColor={card1} icon={readIcon} onButtonClick={scrollToBlogList} />
                </div>
                <div className={`${center} ${gap} `}>
                    <WriteABlogCard loggedIn={loggedIn} setShowLogin={setShowLogin}  width={width} blogsArr={blogsArr} cardColor={card2}/>
                </div>
                <div className={`${center} ${gap} `}>
                    <Card header={'About This Website'} text={aboutText} buttonText={'About Us'} width={width} icon={aboutIcon} cardColor={card3} onButtonClick={goToAboutPage} />
                </div>
            </div>
        </>
    )
