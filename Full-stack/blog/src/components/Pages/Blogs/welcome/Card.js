...
function DefaultCard({ header, text, buttonText, onButtonClick }) {
    return (
        <Card className={`bgColor-primary m-3 rounded-0 rounded-top bg-transparent borderColor-primary`} style={{ width: '20em' }}>
            <Card.Header className='bgColor-primary color-secondary-reverse'>{header}</Card.Header>
            <Card.Body className='bgColor-primaryLight bg-transparent'>
                <Card.Text>
                    {text}
                </Card.Text>
